...
unsigned int nSubsidyHalvingInterval = 525600; // 1 years
...
const string strMessageMagic = "OfflinePartyCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(const CBlockIndex *pindexLast, int64_t nFees)
{
    ...
    {
        nSubsidy = nBestHeight % 10 * 100 * COIN;
    }
    ...
    else if (pindexLast->nMoneySupply + nSubsidy > MAX_MONEY)
    {
        nSubsidy = 0;
    }
...
{
    int halvings = nBestHeight / nSubsidyHalvingInterval;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "OfflinePartyCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Offline Party Coin!";
        CTransaction txNew;
        txNew.nTime = 1529165837;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1529165837;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 53218 : 227923;
...
///////////////////////////
        ...
        assert(block.hashMerkleRoot == uint256("0x9b99e59b7ded658a471b8a8669dd1b84ba97e014b13c5ba296962ee1200f8310"));
...
unsigned char pchMessageStart[4] = { 0x62, 0xc0, 0x46, 0xfe };
